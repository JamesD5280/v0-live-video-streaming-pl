/* eslint-disable */
// @ts-nocheck
// This route serves the streaming-server.js file for VPS deployment.
// The file content is embedded directly because Vercel serverless
// functions cannot access the scripts/ directory at runtime.

export const dynamic = "force-dynamic"

const STREAMING_SERVER_JS = `/**
...
// ... template literal escaping is getting unwieldy. Use a different approach.
...
export async function POST() {
  return new Response("Use GET method", { status: 405 })
}
